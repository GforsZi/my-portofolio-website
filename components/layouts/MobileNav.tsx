    ...
    <div className="">
      ...
      {mounted
        ? createPortal(
            <div
              className={cn(
                "fixed inset-x-0 top-14 bottom-0 z-50 overflow-hidden transition-all duration-500 ease-out",
                open
            ...
            >
              ...
              >
                ...
                >
                  <p className="mb-3 pt-3 font-mono text-xs uppercase tracking-[0.3em] text-muted-foreground">
                    Connect with me
                  </p>
